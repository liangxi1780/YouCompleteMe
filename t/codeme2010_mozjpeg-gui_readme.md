...
用 C# 和 WPF 折腾的一个使用 [MozJPEG](http://u.720life.cn/g/54145d0471d91890860f7f8463c03046b02690d25fe538ef764a25779ae558151cd10e943f15588a9cc5fd9e912b7814)  以 JPEG 格式压缩图片的 GUI 程序。
...
* 只有单个文件，是**绿色版**程序。
    * `cjpeg.exe` 使用的是来自于 [garyzyg/mozjpeg-windows](http://u.720life.cn/g/54145d0471d91890860f7f8463c0304653738e30f3d801d8998c2cf6349cf747ebe05018c827bd15529bfaa8eef34e636c884ead82821685d1236e31816373d3)  的预编译版（3.3.1 x64）， `cwebp.exe` 和 `dwebp.exe` 使用的是来自于 [Google 官方]https://storage.googleapis.com/downloads.webmproject.org/releases/webp/index.html)的预编译版（1.0.3 x64）。
    * 以上程序的二进制文件使用了 [UPX](http://u.720life.cn/g/54145d0471d91890860f7f8463c030467302ec6f9c685459f687b8c3117476f3)  及参数 `--ultra-brute` 进行了压缩，作为资源文件嵌入到程序本体中，程序启动时会将它们释放到临时目录以在运行时调用，在退出时删除。
