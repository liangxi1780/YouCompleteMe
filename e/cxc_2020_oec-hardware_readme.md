...
1. 配置 [openEuler 官方 repo](http://u.720life.cn/g/8d901d4e29852a9b7bd1436efb7b92914f47d6e697125e84682195c4fd4627f7)  中对应版本的 everything 源，以20.03 LTS的版本的everyting源为例，路径为https://repo.openeuler.org/openEuler-20.03-LTS/everything/。使用 `dnf` 安装客户端 oec-hardware。
...
1. 配置 [openEuler 官方 repo](http://u.720life.cn/g/8d901d4e29852a9b7bd1436efb7b92914f47d6e697125e84682195c4fd4627f7)  中对应版本的 everything 源，以20.03 LTS的版本的everyting源为例，路径为https://repo.openeuler.org/openEuler-20.03-LTS/everything/。使用 `dnf` 安装服务端 oec-hardware-server。
